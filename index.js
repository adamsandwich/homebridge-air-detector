...
const BARK_PUSH_URL = 'https://api.day.app';

module.exports = function (homebridge) {
    Service = homebridge.hap.Service;
    Characteristic = homebridge.hap.Characteristic;

    homebridge.registerAccessory('homebridge-air-detector', 'ClearGrassAirDetecter', ClearGrassAirMonitor);
}
...
function ClearGrassAirMonitor(log, config) {
    ...
    this.barkPush = config.barkPush || false;
    this.barkToken = config.barkToken || '';
